...
exports.CVD_MATRICES = void 0;
exports.simulateCvd = simulateCvd;
const convert_1 = require("./convert");
/** Row-major 3x3 matrices mapping (r,g,b) -> simulated (r,g,b). */
exports.CVD_MATRICES = {
...
function simulateCvd(c, type) {
    const m = exports.CVD_MATRICES[type];
    const { r, g, b, a } = c.srgb;
    return (0, convert_1.color)((0, convert_1.clamp01)(m[0] * r + m[1] * g + m[2] * b), (0, convert_1.clamp01)(m[3] * r + m[4] * g + m[5] * b), (0, convert_1.clamp01)(m[6] * r + m[7] * g + m[8] * b), a);
}
