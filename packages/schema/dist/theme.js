...
exports.placeholdersForPage = placeholdersForPage;
exports.resolvePageStyle = resolvePageStyle;
exports.titlePlaceholder = titlePlaceholder;
exports.slideTitle = slideTitle;
exports.themeColor = themeColor;
exports.applyTheme = applyTheme;
exports.themeVariant = themeVariant;
exports.themeFromPalette = themeFromPalette;
exports.builtinMasterAndLayouts = builtinMasterAndLayouts;
 ...
 *  else the file theme. */
function themeForPage(file, page) {
    const master = masterForLayout(file, layoutForPage(file, page));
    if (master?.theme && file.theme?.id === master.theme)
        return file.theme;
    return file.theme;
}
...
function placeholdersForPage(file, page) {
...
function titlePlaceholder(file, page) {
...
function slideTitle(page, index) {
...
function themeVariant(theme, variantId) {
...
function themeFromPalette(id, colors, opts = {}) {
