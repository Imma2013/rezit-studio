...
exports.inlineWordDiff = inlineWordDiff;
...
function inlineWordDiff(before, after) {
...
function pushSpan(spans, text, op) {
...
function diffBlocks(a, b) {
    ...
    for (const block of b) {
        ...
        const entry = { type: "modified", block, before };
