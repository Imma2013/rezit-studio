...
exports.NEAR_DUPLICATE_MAX_DISTANCE = void 0;
exports.averageHash = averageHash;
...
const POPCOUNT = Array.from({ length: 16 }, (_, i) => ((i >> 0) & 1) + ((i >> 1) & 1) + ((i >> 2) & 1) + ((i >> 3) & 1));
...
exports.NEAR_DUPLICATE_MAX_DISTANCE = 5;
function isNearDuplicate(a, b, maxDistance = exports.NEAR_DUPLICATE_MAX_DISTANCE) {
