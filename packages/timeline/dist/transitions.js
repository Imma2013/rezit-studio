...
exports.clampTransition = clampTransition;
exports.addTransition = addTransition;
exports.transitionOverlapRegion = transitionOverlapRegion;
 ...
 */
function clampTransition(t, clip) {
    const max = Math.max(1, (0, model_1.clipDurationFrames)(clip));
 ...
 */
function addTransition(track, clipId, edge, t) {
 ...
 */
function transitionOverlapRegion(a, b) {
    const aEnd = (0, model_1.clipEndFrame)(a);
    ...
    if (start < a.startFrame)
        start = a.startFrame;
    if (end > (0, model_1.clipEndFrame)(b))
        end = (0, model_1.clipEndFrame)(b);
    if (end <= start)
        return null;
