...
exports.voiceActivityFromCues = voiceActivityFromCues;
exports.solveDucking = solveDucking;
 ...
 */
function voiceActivityFromCues(cues) {
    const sorted = cues
 ...
 */
function solveDucking(master, voiceActivity, totalFrames, fps) {
...
function dedupeSorted(points) {
    ...
    for (const p of sorted) {
        ...
        if (last && last.musicGainDb === p.musicGainDb && last.frame === p.frame)
            continue;
        out.push({ ...p });
    }
    return out;
