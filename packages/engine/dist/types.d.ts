...
export interface CanvasLike {
    ...
    lineJoin?: string;
    drawImage?(image: unknown, a: number, b: number, c: number, d: number, dx?: number, dy?: number, dw?: number, dh?: number): void;
...
export interface EngineConfig {
    ...
    interactionQuality: "full" | "adaptive";
}
export type EngineEvent = "frame" | "asset" | "error";
export interface Renderer {
    setViewport(v: Partial<Viewport>): void;
    getViewport(): Viewport;
    fit(mode: "fit" | "fill" | "1:1" | number): void;
