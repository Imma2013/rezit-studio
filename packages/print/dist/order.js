...
exports.OrderTransitionError = void 0;
exports.orderTransition = orderTransition;
exports.canTransition = canTransition;
exports.canCancel = canCancel;
exports.reorderItems = reorderItems;
exports.splitByAddress = splitByAddress;
 ...
 */
function orderTransition(status, event) {
    const next = TRANSITIONS[status]?.[event];
    if (!next)
        throw new OrderTransitionError(status, event);
    return next;
}
 ...
 */
function reorderItems(order, idFor = (it, i) => `${it.id}-reorder-${i}`) {
