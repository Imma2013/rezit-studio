 ...
 */
function shiftEndpoint(ref, opts) {
...
function shiftRef(text, opts) {
    const out = shiftEndpoint((0, refs_1.parseRef)(text), opts);
    return out ?? REF_ERR;
}
/** Rewrite a "range" token (A1:B3) by shifting both endpoints. */
function shiftRangeToken(text, opts) {
    const [a, b] = text.split(":");
    const sa = shiftEndpoint((0, refs_1.parseRef)(a), opts);
    const sb = shiftEndpoint((0, refs_1.parseRef)(b), opts);
